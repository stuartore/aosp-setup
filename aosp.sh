...
' /etc/pacman.conf
	...
	sudo pacman -Syy --noconfirm --needed git git-lfs pcre2 multilib-devel fontconfig ttf-droid yay ccache make yay patch pkg-config maven gradle python-pyelftools
